...
class SearchPageUsaha extends StatefulWidget {
  const SearchPageUsaha({super.key});

  @override
  State<SearchPageUsaha> createState() => _SearchPageUsahaState();
}

class _SearchPageUsahaState extends State<SearchPageUsaha> {
